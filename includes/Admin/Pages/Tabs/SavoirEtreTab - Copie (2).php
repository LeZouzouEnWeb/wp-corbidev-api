...
class SavoirEtreTab
{
    public static function sanitize(array $data): array
    {
        ...
        if (isset($data['savoir_etre']) && is_string($data['savoir_etre'])) {
            // Depuis le textarea
            $values = preg_split("/\r\n|\n|\r/", $data['savoir_etre']);
        } elseif (isset($data['savoir_etre']) && is_array($data['savoir_etre'])) {
            // Depuis les inputs dynamiques
            $values = $data['savoir_etre'];
        }
    ...
    public static function render(array $data): void
    {
        ...
        (function(){
            ...
            // Synchroniser textarea → inputs si nécessaire
            ...
            // Synchroniser inputs → textarea avant submit
