...
?>
        <div class="space-y-6">
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <div class="mb-4">
                    <label class="flex items-center gap-2 cursor-pointer p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                ...
                <div id="driving_licenses_container" 
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-5 gap-3">
                        ...
                        ?>
                            <label class="flex items-center gap-2 p-2 bg-white rounded border border-gray-200 cursor-pointer hover:bg-indigo-50 hover:border-indigo-300 transition-colors">
        ...
        <div class="cv-media-field">
            ...
            <div class="flex flex-col gap-3">
                ...
                <div class="flex gap-2">
                    <button type="button" class="cv-media-select inline-flex items-center px-3 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-colors">
                    ...
                    <button type="button" class="cv-media-remove inline-flex items-center px-3 py-2 bg-red-500 hover:bg-red-600 text-white text-sm font-medium rounded-lg transition-colors <?= $attachment_id ? '' : 'hidden' ?>">
                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            jQuery(document).ready(function($) {
                ...
                $('.cv-media-select').on('click', function(e) {
                    ...
                    frame.on('select', function() {
                        ...
                        preview.html('<img src="' + attachment.sizes.thumbnail.url + '" class="w-24 h-24 object-cover rounded-lg shadow-sm">');
