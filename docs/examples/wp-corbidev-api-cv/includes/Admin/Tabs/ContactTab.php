        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="md:col-span-2">
                ...
                <input type="text" name="contenus[contact][street]" value="<?= esc_attr($data['street'] ?? '') ?>"
                    placeholder="Ex: 123 Rue de la République" pattern="[a-zA-ZÀ-ÿ0-9\s\-_']+"
            ...
            <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="md:col-span-3">
                    ...
                    <input type="text" name="contenus[contact][city]" value="<?= esc_attr($data['city'] ?? '') ?>"
                        placeholder="Paris" pattern="[a-zA-ZÀ-ÿ\s\-_']+"
    ...
    $('form').on('submit', function(e) {
        ...
        $('.cv-text-field').each(function() {
            ...
            if (value !== '' && !pattern.test(value)) {
                ...
                errorMessages.push(label +
                    ' : caractères invalides (seuls lettres, espaces, tirets, underscores et apostrophes sont autorisés)'
                    );
                $(this).addClass('border-red-500');
            }
        });
        ...
        $('.cv-text-field-street').each(function() {
            ...
            if (value !== '' && !pattern.test(value)) {
                ...
                const label = $(this).closest('div').find('label').text().trim();
                errorMessages.push(label +
                    ' : caractères invalides (seuls lettres, chiffres, espaces, tirets, underscores et apostrophes sont autorisés)'
                    );
                $(this).addClass('border-red-500');
            }
        });
