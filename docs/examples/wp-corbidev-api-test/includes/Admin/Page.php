...
class TestPage
{
    ...
    public function render(): void
    {
        ...
        if (isset($_POST['test_save'])) {
            $test_post = $_POST['contenus'] ?? [];
            OptionStore::set('contenus', [
                'example' => ExampleTab::sanitize($test_post['example'] ?? []),
            ]);
            $toast = [
...
<div class="wrap bg-gray-100 min-h-screen">
    <div class="max-w-7xl mx-auto py-8 px-6">
        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-lg shadow-lg p-6 mb-8">
            <h1 class="text-3xl font-bold text-white">Gestion du Test</h1>
            <p class="text-blue-100 mt-2">Administration des informations de test</p>
        </div>
        <form method="post" class="space-y-6">
            ...
            <div class="flex justify-end bg-white p-6 rounded-lg shadow-md">
                <button type="submit" name="test_save"
